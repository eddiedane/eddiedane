...
export default function IlloPage() {
  return (
    ...
    >
      ...
      <div className={cn('lg:container', 'flex flex-col items-center gap-12 px-0 sm:px-0 w-full')}>
        <h1
          className={cn(
        ...
        >
          ...
          >
            ...
            providing clients with simplicity and flexibility in managing their businesses. Founded
            by Tal Hadi, a veteran in the e-commerce space, who was moved by his experience, to
            eliminate the frustrations with using other platforms and consolidate his innovations
        ...
        >
          ...
          <div className={cn('grid grid-cols-12 grid-rows-6 md:gap-12')}>
            <figure className='col-span-12 row-span-3 xl:col-span-4 md:col-span-6 pl-8 pt-6 bg-stone-200 dark:bg-stone-800 rounded-2xl overflow-hidden md:mb-0 mb-10'>
              ...
              <Image src={analytics} width={240} alt='Analytics' className='w-full rounded-s-xl' />
            </figure>
            ...
            <div className='col-span-12 row-span-3 xl:col-span-5 lg:col-span-8 flex flex-col gap-2 justify-center'>
              ...
              <p className='prose prose-sm w-full text-stone-600 dark:text-stone-400'>
                When I initially joined the team as a junior developer, I knew very little about the
                inner workings of e-commerce. However, I was fortunate to have had the opportunity
                to work with the founder who was an expert and with his patience and guidance, I was
                able to learn and grow my skills, working on and implementing features that I never
                would have imagined I could build.
              </p>
              <p className='prose prose-sm w-full text-stone-600 dark:text-stone-400'>
