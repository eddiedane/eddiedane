          ...
          <div className='grid grid-cols-12 grid-rows-1 gap-8'>
            <div className='prose prose-stone dark:prose-invert max-w-none col-span-12 lg:col-span-7 text-justify'>
              ...
              <p className='hidden lg:block'>
                ...
                handles common web scraping challenges like request management, data extraction, and
                error handling behind the scenes, allowing users to focus on defining their desired
                outcomes.
              </p>

              <p>
                Key features include support for multiple scraping strategies, built-in pagination
                logic, flexible data transformation pipelines, and extensive configuration options.
                Whether you're scraping product data or automating repetitive web tasks, Rake
                provides a robust foundation while remaining approachable for users of all technical
                levels.
              </p>
              ...
              <p>
                ...
                easy extension through custom plugins called portals, while maintaining a clean and
                consistent interface for basic use cases.
              </p>

              <p className='hidden lg:block'>
                By abstracting away the complexities of web scraping into configuration files, Rake
                enables rapid development of reliable scraping solutions without sacrificing
                flexibility or control. This makes it a potential valuable tool for developers, data
                analysts, and anyone else who needs to systematically extract data from the web.
              </p>
            </div>
